...
public class TS060_SearchTopic3UI_AttivioMigration_PROG_SRCHPerformingSearch_Searchquery_using_starSymbol {

	public static String TestCase_Name = "TS060_SearchTopic3UI_AttivioMigration_PROG_SRCHPerformingSearch_Searchquery_using_starSymbol";
	...
	@Test	
	public void ts060_SearchTopic3UI_AttivioMigration_PROG_SRCHPerformingSearch_Searchquery_using_starSymbol() throws Exception {
		...
		ExecutionStatus=POM_Lib.SearchTopic3UI_AttivioMigration_PROG_SRCHPerformingSearch_Searchquery_using_starSymbol(retObjArr,TestCase_Name);
